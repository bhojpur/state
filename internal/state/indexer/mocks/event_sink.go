...
import (
	...
	pkgtypes "github.com/bhojpur/state/pkg/types"

	query "github.com/bhojpur/state/internal/pubsub/query"
...
func (_m *EventSink) IndexBlockEvents(_a0 pkgtypes.EventDataNewBlockHeader) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(pkgtypes.EventDataNewBlockHeader) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
